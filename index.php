    ...
    <div id="page-wrapper">
        <div class="row">
            ...
            <div class="overlay-black w-100 slider-banner1 position-relative"
                style="background-image: url('images/banner/3.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-lg-12">
                            <div class="text-white">
                                <h1 class="mb-4"
                                    style="text-shadow: 0 0 3px #874512, 0 0 5px #FFFFFF; -webkit-text-stroke: 1px white; ">
                                    <span class="text-success">Aaiye </span><br>
                                    Aapka Ghar Khoje
                                </h1>
        ...
        ======================================================-->
            <div class="full-row bg-gray">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="text-secondary double-down-line text-center mb-5">Hum Aapke Liye karte Hai</h2>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Selling
                                            Service</a></h5>
                                    <p>Hum Bilaspur Me Kahi Bhi Property Bechni ya Kharidne ki Facility dete hai .</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Rental
                                            Service</a></h5>
                                    <p>Yha Aapko Bilaspur me Makan Kiraye Se mil jayega </p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Property
                                            Listing</a></h5>
                                    <p>Aapko apna Property Listing karana ho, karidna, bechna ya Rental k liye list kara
                                        Sakte ho</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s">
                                    ...
                                    <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Legal
                                            Investment</a></h5>
                                    <p>aap Real Estate me Invest kar skte hai, Legally with Transpirancy ke sath, with
                                        trust </p>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="featured-thumb hover-zoomer mb-4">
                                                <div class="overlay-black overflow-hidden position-relative"> <img
                                                    ...
                                                    <div class="price text-primary"><b>&#8377
                                                            <?php echo $row['13']; ?>
            ...
            <div class="full-row living bg-one overlay-secondary-half"
                style="background-image: url('images/3.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container">
                    <div class="row">
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>Hamare grahako dwara diye gaye Great Rating ka Prapt hona hamara Vishesta
                                                hai. jiske karan BilaspurProperty.com pure Chhattisgarh me Top rated
                                                hai. </p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>Hamare Company me 10 saal ke Anubhaw agents hai jo aapko. property deal
                                                karne achha anubhaw karate hai</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>hamare Dal ke anubhawi agent log aapke Sapne ko hakkikat Karne me Maddad
                                                karte hai. hame is baat pe Garv hai.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>Aap Pahle Listed property ko achhe se Dekhte hai, Direct Property ke Owner se baat
                                    karte hai, fir process aage forward hota hai</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>aapke Final kiye gye property per uske Documents Verify kiye jaaye hai,</p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="icon-thumb-one text-center mb-5">
                                ...
                                <p>Saare Documents Verified Hone pr aap Deal Done Karte hai</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        ============================================================-->
            <div class="full-row overlay-secondary"
                style="background-image: url('images/Achh.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <img src="images/thumbnail4/nehrunagar.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <h4 class="hover-text-success text-capitalize"><a
                                                    href="stateproperty.php?id=<?php echo $row['17'] ?>">
                                                    <?php echo $row['state']; ?>
                                                </a></h4>
                                            <span>
                                                <?php
                                                $total = $row[0];
                                                echo $total; ?> Properties Listed
                                            </span>
                                        </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9">
                                    <img src="images/thumbnail4/golbazar.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9">
                                    <img src="images/thumbnail4/Linkroad.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9">
                                    <img src="images/thumbnail4/riverview.jpg" alt="">
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                            ...
                            <div class="content-sidebar p-4">
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-success">
                                        "Maine BilaspurProperty.com ka istemal kiya aur mujhe unki services se kaafi
                                        khushi mili. Unki website par property listings ki range bahut adhik hai aur
                                        unki team ne meri property ke liye perfect buyer dhoondhne mein madad ki. Unka
                                        customer support bhi bahut responsive aur helpful tha. Main unki services ko
                                        bharosa dilane ke liye behtareen tareeke se recommend karunga."
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <div class="item">
                                                <div class="p-4 bg-success down-angle-white position-relative">
                                                    <p class="text-white"><i class="fas fa-quote-left mr-2 text-white"></i>
                                                        <?php echo $row['2']; ?>. <i
                                                            class="fas fa-quote-right mr-2 text-white"></i>
                                                    </p>
                                                </div>
                                                <div class="p-2 mt-4">
                                                    <span class="text-success d-table text-capitalize">
                                                        <?php echo $row['uname']; ?>
