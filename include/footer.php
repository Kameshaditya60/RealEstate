<footer class="full-row bg-secondary p-0">
    <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-4">
                            <div class="footer-widget mb-4">
                                <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom"
                                            src="images/logo/bilaspurproperty.png" alt="image"></a> </div>
                                <p class="pb-20 text-white"> Bilaspurperoperty.com Ko hum India Ka Best Real estate
                                    website banana Chahte hai, jaha par hum aapko koi sa bhi property se related deal
                                    saste me dila sake.</p>
                                    ...
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            <li class="hover-text-primary"><i
                                                    class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Geetanjali
                                                City Phase 2, Bilaspur, Chhattisgarh</li>
                                            <li class="hover-text-primary"> <i
                                            ...
                                            <li class="hover-text-primary"> <i
                                                ...
                                                9691361784</li>
                                            <li class="hover-text-primary"><i
                                                    class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>bilaspurproperty@gmail.com
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="row copyright">
            <div class="col-sm-6"> <span class="text-white">©
                    <?php echo date('Y'); ?> bilaspurproperty Website - Developed By Kamesh Kumar Aditya
                </span> </div>
            <div class="col-sm-6">
